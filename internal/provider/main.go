...
func Provider() *schema.Provider {
	return &schema.Provider{
		DataSourcesMap: map[string]*schema.Resource{
			...
			"nexus_repository_terraform_group":            repository.DataSourceRepositoryTerraformGroup(),
			"nexus_repository_terraform_hosted":           repository.DataSourceRepositoryTerraformHosted(),
			"nexus_repository_terraform_proxy":            repository.DataSourceRepositoryTerraformProxy(),
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"nexus_repository_terraform_group":            repository.ResourceRepositoryTerraformGroup(),
			"nexus_repository_terraform_hosted":           repository.ResourceRepositoryTerraformHosted(),
			"nexus_repository_terraform_proxy":            repository.ResourceRepositoryTerraformProxy(),
