...
func testAccProResourceRepositoryDockerProxy() repository.DockerProxyRepository {
	enableCircularRedirects := true
	enableCookies := true
	retries := 3
	timeout := 15
...
func TestAccProResourceRepositoryDockerProxy(t *testing.T) {
	...
	repo := testAccProResourceRepositoryDockerProxy()
	repo.RoutingRule = &routingRule.Name
	resourceName := "nexus_repository_docker_proxy.acceptance"
