...
func testAccDataSourceRepositoryRubygemsHostedConfig() string {
	return `
data "nexus_repository_rubygems_hosted" "acceptance" {
	name   = nexus_repository_rubygems_hosted.acceptance.id
}`
}

func TestAccDataSourceRepositoryRubygemsHosted(t *testing.T) {
	...
	dataSourceName := "data.nexus_repository_rubygems_hosted.acceptance"
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccResourceRepositoryRubygemsHostedConfig(repo) + testAccDataSourceRepositoryRubygemsHostedConfig(),
