...
func testAccResourceRepositoryTerraformHosted() repository.RawHostedRepository {
...
func testAccResourceRepositoryTerraformHostedConfig(repo repository.RawHostedRepository) string {
	buf := &bytes.Buffer{}
	tmpl := template.Must(template.New("TerraformHostedRepository").Funcs(acceptance.TemplateFuncMap).Parse(acceptance.TemplateStringRepositoryTerraformHosted))
...
func TestAccResourceRepositoryTerraformHosted(t *testing.T) {
	repo := testAccResourceRepositoryTerraformHosted()
	resourceName := "nexus_repository_terraform_hosted." + repo.Name
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccResourceRepositoryTerraformHostedConfig(repo),
