...
func DataSourceSecuritySSL() *schema.Resource {
	return &schema.Resource{
		Description: `Use this data source to retrieve a SSL certificate from any Nexus-external hostvia Nexus.
		This resource does NOT retrieve a certificate from the Nexus truststore`,

		Read: dataSourceSecuritySslRead,
...
func dataSourceSecuritySslRead(d *schema.ResourceData, m interface{}) error {
