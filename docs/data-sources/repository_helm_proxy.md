---
page_title: "Data Source nexus_repository_helm_proxy"
subcategory: "Repository"
description: |-
  Use this data source to get an existing helm proxy repository.
---
# Data Source nexus_repository_helm_proxy
Use this data source to get an existing helm proxy repository.
## Example Usage
```terraform
