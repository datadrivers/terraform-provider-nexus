...
func testAccResourceRepositoryPyPiProxy() nexus.Repository {
	repo := testAccResourceRepositoryProxy(nexus.RepositoryFormatPyPi)
	repo.RepositoryProxy.RemoteURL = "https://pypi.org"
	return repo
}
